...
those given by Huang's mean field results.  They both show the
characteristic oscillations in the pill shaped cells.  We do not see
any compelling reason to avoid using this simple and successful model.
