...
\begin{multline}
  \frac{\partial n_{D:ADP}}{\partial t} = D_D\nabla^2n_{D:ADP}-\sigma_D^{ADP\rightarrow ATP}n_{D:ADP}\\
  +\delta(r-R)\sigma_{de}n_{de}\hspace{3.4cm}
\end{multline}
\begin{multline}
  \frac{\partial n_{D:ATP}}{\partial t} = D_D\nabla^2n_{D:ATP}+\sigma_D^{ADP\rightarrow ATP}n_{D:ADP}\\
  -\sigma(r-R)[\sigma_D+\sigma_{dD}(n_d+n_{de})]n_{D:ATP}
\end{multline}
\begin{multline}
  \frac{\partial n_E}{\partial t} = D_E\nabla^2n_E+\delta(r-R)\sigma_{de}n_{de}\\
  -\delta(r-R)\sigma_E n_d n_E\hspace{3.3cm}
\end{multline}
\begin{multline}
  \frac{\partial n_d}{\partial t} = -\sigma_En_dn_E(R)\\
  +[\sigma_D+\sigma_{dD}(n_d+n_{de})]n_{D:ATP}(R)\hspace{.9cm}
\end{multline}
\begin{multline}
  \frac{\partial n_{de}}{\partial t} = -\sigma_{de}n_{de}+\sigma_En_dn_E(R)\hspace{3cm}
\end{multline}
