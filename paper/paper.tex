...
Modelled cells have a total cell volume that is roughly equivelent to
that observed experimentally by Kubitschek.\cite{kubitschek1990cell}
He observes mean cell volumes of 0.69$\mu m^3$ and 0.58$\mu m^3$ in
different strains and shows as well that newborn cells have roughly half
the volume of those on the brink of cell division.  Because we are
interested in the protein system during the cell division process, we
use cells that have cell volumes of roughly 1 $\mu m^3$
