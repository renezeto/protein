...
Equation~\ref{fig:FourthPDE}.  When brushing up against the cell
...
Equations \ref{fig:FourthPDE} and \ref{fig:FifthPDE} will only be
...
A 3d grid is constructed in cartesian coordinates with a grid spacing
of .05\micron. We define our cell shapes and solve the
reaction-diffusion equations numerically to observe the time evolution
of the MinD and MinE concentrations inside the cell.
